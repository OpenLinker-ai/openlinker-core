...
func (s *Service) DeliverRun(ctx context.Context, userID, runID uuid.UUID, targetID *uuid.UUID) (*DeliveryItem, error) {
	...
	go s.attemptInBackground(delivery.ID) // #nosec G118 -- delivery attempt intentionally outlives the request context.
...
func (s *Service) RetryDelivery(ctx context.Context, deliveryID, userID uuid.UUID) error {
	...
	go s.attemptInBackground(deliveryID) // #nosec G118 -- retry attempt intentionally outlives the request context.
	return nil
}
