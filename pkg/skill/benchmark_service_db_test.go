...
const truncateBenchmarkSkillTables = "TRUNCATE agent_skill_benchmark_runs, agent_skill_scores, webhook_deliveries, runs, task_queries, agent_tokens, agent_availability_snapshots, agent_skills, agents, users RESTART IDENTITY CASCADE"
